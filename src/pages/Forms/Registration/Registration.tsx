...
import { INIT_STATE, formReducer } from "./Registration.state";
import { sendRegistration } from "../../../store/user.slice";
    ...
    <form className={styles["form"]} onSubmit={handleSubmitForm}>
      <div className={styles["form__wrapper"]}>
        ...
        {registerErrorMessage && (
          <p className={styles["form__error"]}>{registerErrorMessage}</p>
        )}
